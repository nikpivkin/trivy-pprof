module github.com/nikpivkin/trivy-pprof

go 1.22.2

replace github.com/testcontainers/testcontainers-go/modules/localstack => github.com/testcontainers/testcontainers-go/modules/localstack v0.28.0

require github.com/aquasecurity/trivy v0.50.1
